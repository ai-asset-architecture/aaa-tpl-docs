...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-03-01 | v2.0.1 | Guide Parity Gate (Core vs Template) | 建立兩份 workflow law guide 的 CI parity gate，確保 canonical sections 長期一致。 | 避免 `aaa-docs` 與 `aaa-tpl-docs` guide 長期漂移，導致繼承專案與核心治理語義分叉。 | governance:operate_maintain_workflow_v2 | UNVERIFIED | run_ref=N/A (step2-pending); evidence=operate_maintain_guide.md,workflow_index.md,scripts/gates/verify_operate_maintain_guides.py,.github/workflows/v2-0-1-guide-parity-gate.yml,docs/plans/2026-03-01-v2.0.1-guide-parity-gate-plan.md,docs/audits/2026-03-01-v2.0.1-guide-parity-gate-audit.md,docs/reviews/2026-03-01-v2.0.1-guide-parity-gate-diff-paths.md,docs/reviews/2026-03-01-v2.0.1-step2-exit-checklist.md,docs/contracts/ops/guide-parity-report.v0.1.schema.json,docs/contracts/ops/ops-version-step-block.v0.1.schema.json; note=step1-approved-step2-blocked-remote-evidence-missing |
